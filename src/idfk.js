class idfk{
    ...
    async short_url(url,slug=""){
        let req=await fetch(`${this.api}/url`,{method:"POST",body:JSON.stringify({"slug":slug,"url":url}),headers: this.headers});
